...
describe('data', () => {
  ...
  describe('data.loadData', () => {
    ...
    it('dataModified debe ser del mismo tamaño que la data INJURIES', () => {
      data.loadData();
  ...
  describe('data.percent', () => {
    ...
    it('debería retornar el porcentaje según el medio de transporte y el año seleccionado', () => {
  ...
  describe('data.changeYearsToList', () => {
    ...
    it('debería retornar un arreglo cuando se pasa un string de años', () => {
