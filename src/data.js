window.data = {
  ...
  //función que captura los datos de la fuente original
  loadData: () => {
    for (let i = 0; i < INJURIES.length; i++) {

      let year = INJURIES[i].Year.substring(0, 4);

      //data para transporte aéreo
      let air = [{
  ...
  //esta función convierte el string de la selección de años en un arreglo
